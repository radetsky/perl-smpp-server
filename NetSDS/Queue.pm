...
L<http://memcachedb.org/memcacheq/> - MemcacheQ server

L<http://openhack.ru/Cache-Memcached-Fast> - Perl XS API to Memcached servers

=head1 TODO

* implement tokyocabinet storage support

* implement DBI storage support
